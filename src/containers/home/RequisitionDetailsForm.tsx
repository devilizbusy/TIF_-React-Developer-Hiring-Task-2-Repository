...
const RequisitionDetailsForm: React.FC<{
  ...
  onUpdateRequisitionDetails: (field: keyof IRequisitionDetails, value: any) => void;
}> = ({ handleTab, requisitionDetails, onUpdateRequisitionDetails }) => {
  const {
    handleChange,
    errors,
    touched,
  ...
  const handleFieldChange = (field: keyof IRequisitionDetails, value: any) => {
    ...
    onUpdateRequisitionDetails(field, value);
  };
